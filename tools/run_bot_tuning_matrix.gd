...
static func _strategic_arguments(strategic_options: Dictionary) -> Array[String]:
	var args: Array[String] = []
	if strategic_options.is_empty():
		return args
	if strategic_options.has("strategic_search"):
		args.append("--strategic-search=%s" % str(strategic_options.get("strategic_search", "")))
	if strategic_options.has("strategic_budget_profile"):
		args.append("--strategic-budget-profile=%s" % str(strategic_options.get("strategic_budget_profile", "")))
	if strategic_options.has("strategic_horizon_decisions"):
		args.append("--strategic-horizon-decisions=%d" % int(strategic_options.get("strategic_horizon_decisions", 0)))
	if strategic_options.has("strategic_horizon_rounds"):
		args.append("--strategic-horizon-rounds=%d" % int(strategic_options.get("strategic_horizon_rounds", 0)))
	if strategic_options.has("strategic_max_plans"):
		args.append("--strategic-max-plans=%d" % int(strategic_options.get("strategic_max_plans", 0)))
	if strategic_options.has("strategic_rollout_step_budget_ms"):
		args.append("--strategic-rollout-step-budget-ms=%d" % int(strategic_options.get("strategic_rollout_step_budget_ms", 0)))
...
static func _effective_strategic_options(strategic_options: Dictionary) -> Dictionary:
	var out := strategic_options.duplicate(true)
	if not out.has("strategic_budget_profile") or str(out.get("strategic_budget_profile", "")).strip_edges().is_empty():
		out["strategic_budget_profile"] = "tuning"
	return out
