...
const DinnertimeEventsClass = preload("res://modules/base_rules/rules/phase/dinnertime/dinnertime_events.gd")
...
const DinnertimeSelectionClass = preload("res://modules/base_rules/rules/phase/dinnertime/dinnertime_selection.gd")
