...
const InstanceExpirationClass = preload("res://modules/base_rules/rules/phase/marketing/settlement_instance_expiration.gd")
const ProductsClass = preload("res://modules/base_rules/rules/phase/marketing/settlement_products.gd")
const HouseDemandClass = preload("res://modules/base_rules/rules/phase/marketing/settlement_house_demand.gd")
const DemandEffectsClass = preload("res://modules/base_rules/rules/phase/marketing/settlement_demand_effects.gd")
