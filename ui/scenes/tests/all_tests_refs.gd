...
const OnlineResumeArchiveRecoveryTestClass = preload("res://core/tests/online_resume_archive_recovery_test.gd")
const OnlineResumeStartValidationTestClass = preload("res://core/tests/online_resume_start_validation_test.gd")
const OnlineResumeFullSnapshotBootstrapTestClass = preload("res://core/tests/online_resume_full_snapshot_bootstrap_test.gd")
const OnlineResumeSingleFullEngineCacheTestClass = preload("res://core/tests/online_resume_single_full_engine_cache_test.gd")
...
const OnlineRoundAutosaveTestClass = preload("res://core/tests/online_round_autosave_test.gd")
const ExportMatchArtifactsContractTestClass = preload("res://core/tests/export_match_artifacts_contract_test.gd")
...
const StrategicPlanTestClass = preload("res://core/tests/ai/strategic_plan_test.gd")
const StrategicGuardedOverrideTestClass = preload("res://core/tests/ai/strategic_guarded_override_test.gd")
...
const CleanupPreviewGoldenTestClass = preload("res://core/tests/ai/cleanup_preview_golden_test.gd")
...
const StaffStateTestClass = preload("res://core/tests/staff_state_test.gd")
...
const LeftPanelViewSelectionPersistenceTestClass = preload("res://ui/scenes/tests/left_panel_view_selection_persistence_test.gd")
...
const RewindTurnStartActorIdTestClass = preload("res://core/tests/rewind_turn_start_actor_id_test.gd")
...
const WorkingPanelsVisibleSyncTestClass = preload("res://ui/scenes/tests/working_panels_visible_sync_test.gd")
...
const MapBalanceAnalyzerTestClass = preload("res://core/tests/map_balance_analyzer_test.gd")
const BalancedMapsModuleTestClass = preload("res://core/tests/balanced_maps_module_test.gd")
...
const OnlineRestructuringReopenPendingTestClass = preload("res://core/tests/online_restructuring_reopen_pending_test.gd")
