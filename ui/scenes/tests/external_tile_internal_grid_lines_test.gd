# external_tile_placements tile borders should include inner grid lines (same as tile_placements).
# Covers regression: newly placed tiles (e.g. lobbyists extra map tile) should match base tile style.
class_name ExternalTileInternalGridLinesTest
extends RefCounted
