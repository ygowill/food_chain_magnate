...
const GameSaveLoadControllerClass = preload("res://ui/scenes/game/controllers/save_load_controller.gd")
const GameLayoutControllerClass = preload("res://ui/scenes/game/controllers/layout_controller.gd")
...
const GameCommandControllerClass = preload("res://ui/scenes/game/controllers/command_controller.gd")
const GameInputControllerClass = preload("res://ui/scenes/game/controllers/input_controller.gd")
const GameLogDockControllerClass = preload("res://ui/scenes/game/controllers/log_dock_controller.gd")
const GameBackgroundWarmupControllerClass = preload("res://ui/scenes/game/controllers/background_warmup_controller.gd")
const GameDebugPanelControllerClass = preload("res://ui/scenes/game/controllers/debug_panel_controller.gd")
...
static func build(host: Control, refs: Dictionary, callbacks: Dictionary, startup_replay_from_main_menu: bool) -> Dictionary:
	...
	var timeline_controller = GameTimelineControllerClass.new(
		...
		refs.get("action_panel", null),
		callbacks.get("get_game_engine", Callable()),
		callbacks.get("get_runtime_game_engine", Callable()),
		callbacks.get("set_active_game_engine", Callable()),
		callbacks.get("set_display_game_engine", Callable()),
		callbacks.get("update_ui", Callable()),
