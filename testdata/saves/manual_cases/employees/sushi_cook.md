# employee/sushi_cook - 员工（sushi_cook）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/sushi_cook.json`
- 玩家数: 2
- Seed: 12345
...
1. 载入后应处于 Working/GetFood，且玩家 0 在岗包含 sushi_cook。
2. 行动面板选择「生产食物」并执行。
