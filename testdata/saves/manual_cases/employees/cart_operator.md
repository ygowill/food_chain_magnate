# employee/cart_operator - 采购员工（cart_operator）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/cart_operator.json`
- 玩家数: 2
- Seed: 12345
...
2. 行动面板选择「采购饮料」。
3. 选择 employee_type=cart_operator，并在地图上点选 1~N 个饮料来源生成路线后确认执行。
