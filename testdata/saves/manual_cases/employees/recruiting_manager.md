# employee/recruiting_manager - 招聘能力员工（recruiting_manager）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/recruiting_manager.json`
- 玩家数: 2
- Seed: 12345
...
1. 载入后应处于 Working/Recruit，且玩家 0 在岗包含 recruiting_manager。
