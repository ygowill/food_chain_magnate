# employee/discount_manager - 强制定价员工（discount_manager）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/discount_manager.json`
- 玩家数: 2
- Seed: 12345
...
- 验证强制动作 set_discount 的可执行性与 round_state 写入。
