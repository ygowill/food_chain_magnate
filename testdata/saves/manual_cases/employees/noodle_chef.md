# employee/noodle_chef - 员工（noodle_chef）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/noodle_chef.json`
- 玩家数: 2
- Seed: 12345
...
1. 载入后应处于 Working/GetFood，且玩家 0 在岗包含 noodle_chef。
2. 行动面板选择「生产食物」并执行。
