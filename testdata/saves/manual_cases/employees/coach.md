# employee/coach - 培训员工（coach）

## 存档

- JSON: `res://testdata/saves/manual_cases/employees/coach.json`
- 玩家数: 2
- Seed: 12345
...
1. 载入后应处于 Working/Train，且玩家 0 在岗包含 coach；reserve_employees 包含 management_trainee。
