...
- `skill-index.json` 由仓库内 Skill 的触发描述和 UI metadata 编译生成；
- 禁止手工编辑生成文件；
- 修改正式文档后运行 `python3 tools/docs_governance.py --write-index`；修改 Skill 后运行 `python3 tools/skills_governance.py --write-index`；
